...
def category(category_str):
    ...
    return render_template("index.html", news=news, current_user=current_user, title=f'Записи в категории {category_str}')
...
def index():
    ...
    return render_template("index.html", news=news, current_user=current_user, title='Записи в блоге')
